...
from AsbhaiMusic import Carbon, app, EMOJIS
from AsbhaiMusic.utils.decorators.language import language, languageCB
from AsbhaiMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
from AsbhaiMusic.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from AsbhaiMusic import YouTube
