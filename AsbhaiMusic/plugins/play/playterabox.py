...
from AsbhaiMusic import app, TeraboxAPI  # Make sure to import your new TeraboxAPI
from AsbhaiMusic.core.call import Champu
from AsbhaiMusic.utils.database import is_active_chat
from AsbhaiMusic.utils.stream.queue import put_queue
