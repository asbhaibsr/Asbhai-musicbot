...
from AsbhaiMusic import HELPABLE, app
from AsbhaiMusic.utils.database import get_lang, is_commanddelete_on
from AsbhaiMusic.utils.decorators.language import LanguageStart
from AsbhaiMusic.utils.inline.help import private_help_panel
...
async def about_callback(client: Client, callback_query: CallbackQuery):
    buttons = [
        ...
        [
            InlineKeyboardButton(text="[ ɢʀᴏᴜᴘ ]", url="https://t.me/aschat_group"),
            InlineKeyboardButton(text="[ ᴄʜᴀɴɴᴇʟ ]", url=f"https://t.me/asbhai_bsr"),
        ],
        [
...
async def music_callback(client: Client, callback_query: CallbackQuery):
    ...
    await callback_query.message.edit(
        f"``**Cʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.  Iғ ʏᴏᴜ'ʀᴇ ғᴀᴄɪɴɢ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ɪɴ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ.](t.me/aschat_group)**\n\n**Aʟʟ ᴄᴏᴍᴍᴀɴᴅs ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴡɪᴛʜ: /**``",
        reply_markup=keyboard,
    )
...
async def back_button_callback(client: Client, callback_query: CallbackQuery):
    keyboard = [
        [
            ...
            InlineKeyboardButton(
                text="ɢɪᴛʜᴜʙ",
                url="https://github.com/asbhaibsr",
            ),
        ],
        [
